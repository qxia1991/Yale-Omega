...
def init():
  ...
  CalibrationOutput = '/nfs/slac/g/exo_data4/users/Energy/data/results/calibration/2017_Phase2_030717/rotated/%s/'%(cutName)
  AngleFitterOutput = '/nfs/slac/g/exo_data4/users/Energy/data/results/angle/2017_Phase2_030717/'
  isDenoised = False
  useAngleFile = True
  angleFile = '/nfs/slac/g/exo_data4/users/maweber/software/Devel/EXOEnergy/scripts/WeeklyAngle_Phase2_030717.txt'
