...
#		Reprocessed data after wire gain update
#
# Created:	11-21-16
...
def init():
  ...
  RecoFileName = '/nfs/slac/g/exo-userdata/users/mjjewell/Analysis/Reproc_NewWireGains_11_20_2016/[RunNumber]/reproc0000[RunNumber]-*.root'
  DataTreeFileName = '/nfs/slac/g/exo_data6/groups/Energy/data/WIPP/preprocessed/2016_restart_NewWireGains_112116/ForCalibration/run_[RunNumber]_tree.root'
  SelectionTreeFileName = '/nfs/slac/g/exo_data6/groups/Energy/data/WIPP/selection/2016_restart_NewWireGains_112116/ForCalibration/%s/run_[RunNumber]_tree.root'%(cutName)
  DataMultiplicityWildcard = '[MULTIPLICITY]'
  DataId = 'run_[RunNumber]_[MULTIPLICITY]'
  MCTreeFileName = '/nfs/slac/g/exo_data6/groups/Fitting/data/MC/preprocessed/2014_Majoron/'
  MCSelectionFileName = '/nfs/slac/g/exo_data6/groups/Fitting/data/MC/selection/2014_Majoron/'
  minWeek = 234
  maxWeek = 264
  ...
  CalibrationOutput = '/nfs/slac/g/exo_data4/users/Energy/data/results/calibration/2016_restart_NewWireGains_112116/rotated/%s/'%(cutName)
  AngleFitterOutput = '/nfs/slac/g/exo_data4/users/Energy/data/results/angle/2016_061616/'
  isDenoised = False
  useAngleFile = True
  angleFile = '/nfs/slac/g/exo_data4/users/maweber/software/Devel/EXOEnergy/scripts/WeeklyAngle_061616_NonDenoised.txt'
  FitRange = [1200,6000,0,6000]
