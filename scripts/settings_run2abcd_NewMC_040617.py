...
#
# Calibration:	run2abcd dataset after re-prcessing the data
#		with new lightmap. This calibraiton uses the
#		new MC that includes risetime fix
#
# Created:	04-06-17
...
def init():
  ...
  DataTreeFileName = '/nfs/slac/g/exo_data6/groups/Energy/data/WIPP/preprocessed/2016_run2abcd/ForCalibration/run2abcd_run_[RunNumber]_tree.root'
  SelectionTreeFileName = '/nfs/slac/g/exo_data6/groups/Energy/data/WIPP/selection/2016_run2abcd/ForCalibration/%s/run2abcd_run_[RunNumber]_tree.root'%(cutName)
  DataMultiplicityWildcard = '[MULTIPLICITY]'
  DataId = 'run2abcd_run_[RunNumber]_[MULTIPLICITY]'
  ...
  CalibrationOutput = '/nfs/slac/g/exo_data4/users/Energy/data/results/calibration/2017_run2abcd_NewMC/rotated/%s/'%(cutName)
  AngleFitterOutput = '/nfs/slac/g/exo_data4/users/Energy/data/results/angle/2017_run2abcd_NewMC/'
  isDenoised = True
  useAngleFile = False
  angleFile = ''
  FitRange = [1000,5000,0,5000]
  ...
  ShapeAgreeOutput = '/nfs/slac/g/exo_data4/users/maweber/software/Devel/EXOEnergy/scripts/srcAgreePlots_run2abcd.root'
