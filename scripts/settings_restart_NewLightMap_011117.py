...
#		This data was processed with the new light map
#
# Created:	11-01-17
...
def init():
  ...
  CalibrationOutput = '/nfs/slac/g/exo_data4/users/Energy/data/results/calibration/2017_restart_NewLightMap_011117/rotated/%s/'%(cutName)
  AngleFitterOutput = '/nfs/slac/g/exo_data4/users/Energy/data/results/angle/2016_110116/'
  isDenoised = False
  useAngleFile = True
