...
def init():
  ...
  SourceRunsFileName = '../data/UpdatedLivetimeSourceRunsInfo_Phase2_NoisePeriods_20170424.txt'
  ...
  CalibrationOutput = '/nfs/slac/g/exo_data4/users/Energy/data/results/calibration/2017_Phase2_050217/FullRange/rotated/%s/'%(cutName)
  AngleFitterOutput = '/nfs/slac/g/exo_data4/users/Energy/data/results/angle/2017_Phase2_042417/'
  isDenoised = False
  useAngleFile = True
  angleFile = '/nfs/slac/g/exo_data4/users/maweber/software/Devel/EXOEnergy/scripts/WeeklyAngle_Phase2_042417.txt'
