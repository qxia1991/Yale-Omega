...
def init():
  ...
  DataTreeFileName = '/nfs/slac/g/exo_data6/groups/Energy/data/WIPP/preprocessed/2017_Phase1_NonDenoised_071217/ForCalibration/run_[RunNumber]_tree.root'
  SelectionTreeFileName = '/nfs/slac/g/exo_data6/groups/Energy/data/WIPP/selection/2017_Phase1_NonDenoised_071217/ForCalibration/%s/run_[RunNumber]_tree.root'%(cutName)
  ...
  CalibrationOutput = '/nfs/slac/g/exo_data4/users/Energy/data/results/calibration/2017_Phase1_NonDenoised_071217/rotated/%s/'%(cutName)
